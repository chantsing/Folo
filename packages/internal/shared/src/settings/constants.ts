...
export const PAID_SETTINGS = {
  general: {
    summary: SettingPaidLevels.Free,
    translation: SettingPaidLevels.Free,
    translationMode: SettingPaidLevels.Free,
    hidePrivateSubscriptionsInTimeline: SettingPaidLevels.Free,
  },
  ui: {
    hideExtraBadge: SettingPaidLevels.Free,
    hideRecentReader: SettingPaidLevels.Free,
  },
  integration: {
    enableCubox: SettingPaidLevels.Free,
    enableObsidian: SettingPaidLevels.Free,
    enableOutline: SettingPaidLevels.Free,
    enableReadwise: SettingPaidLevels.Free,
    enableZotero: SettingPaidLevels.Free,
    enableInstapaper: SettingPaidLevels.Free,
    enableReadeck: SettingPaidLevels.Free,
    enableEagle: SettingPaidLevels.Free,
    enableQBittorrent: SettingPaidLevels.Free,
    enableCustomIntegration: SettingPaidLevels.Free,
  },
  ai: {},
} as const satisfies {
